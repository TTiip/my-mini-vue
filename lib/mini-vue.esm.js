...
var creareRenderInstance = function (options) {
...
var patchProp = function (el, key, props) {
    // 事件 onClick --> 具体 --> 通用
    // on + event name
    // 匹配是否是事件
    var val = props[key];
...
var renderInstance = creareRenderInstance({
...
var createApp = function () {
    ...
    return renderInstance.createApp.apply(renderInstance, args);
};

export { Fragment, Text, creareRenderInstance, createApp, createComponentInstance, createElement, createNode, createTextVNode, finishComponentSetup, getCurrentInstance, getShapeFlag, h, handleSetupResult, inject, insert, patchProp, provide, renderInstance, renderSlots, setupComponent, setupStatefulComponent };
