...
var createRender = function (options) {
    ...
    var mountComponent = function (initinalVNode, container, parentComponent) {
...
export { Fragment, Text, createApp, createAppAPI, createComponentInstance, createElement, createRender, createTextVNode, createVNode, getCurrentInstance, h, inject, insert, patchProp, provide, render, renderSlots, setupComponent, setupStatefulComponent };
